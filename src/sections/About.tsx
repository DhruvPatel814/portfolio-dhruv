    ...
    >
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <motion.div
          ...
          className="
            w-32 md:w-52 lg:w-60
            aspect-square rounded-full overflow-hidden
            shadow-xl border-4 border-indigo-500
        ...
        <div>
          ...
          >
            ...
            <span className="font-semibold">
              C++, Java, SQL, React, and Tailwind CSS
            </span>. I also have hands-on experience with{" "}
            <span className="font-semibold">
              Oracle APEX, backend logic, and IoT-based solutions
            </span>.
            <br /><br />
            Apart from coding, I participate in hackathons and enjoy building
            practical projects like EduConnect, Task Management System, and AI Chatbot.
          </motion.p>
        </div>
      </div>
    </section>
